 ...
 * @author Jose Ayala
 */
public class frmvistapaciente_dieta extends javax.swing.JFrame {

    /**
     * Creates new form frmvistapaciente
     */
    public frmvistapaciente_dieta() {
        initComponents();
        mostrar("");
    ...
    private void tablalistadoMousePressed(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_tablalistadoMousePressed
        if (evt.getClickCount()==2) {
            ...
            frmcargar_dieta.txtidpaciente11.setText(cod);
            frmcargar_dieta.txtpaciente.setText(valor);
            dispose();
        }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(frmvistapaciente_dieta.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new frmvistapaciente_dieta().setVisible(true);
            }
        });
    }
