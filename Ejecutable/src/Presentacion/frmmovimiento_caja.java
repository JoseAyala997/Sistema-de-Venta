...
//        dtfecha_apertura.set("");
    ...
    private void btncierreActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btncierreActionPerformed
        ...
        //        dts.setIdmovimiento(Integer.parseInt(txtidmovimiento.getText()));
        dts.setCierre(Long.parseLong(txtmonto_cierre.getText()));
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(frmmovimiento_caja.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new frmmovimiento_caja().setVisible(true);
            }
        });
    }
