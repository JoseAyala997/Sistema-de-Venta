 ...
 * @author Jose Ayala
 */
public class frmvistapaciente extends javax.swing.JFrame {

    /**
     * Creates new form frmvistapaciente
     */
    public frmvistapaciente() {
        initComponents();
        mostrar("");
    ...
    private void initComponents() {
        ...
        jPanel5Layout.setHorizontalGroup(
            ...
            .addGroup(jPanel5Layout.createSequentialGroup()
                ...
                .addComponent(txtbuscar5, javax.swing.GroupLayout.PREFERRED_SIZE, 240, javax.swing.GroupLayout.PREFERRED_SIZE)
    ...
    private void tablalistadoMousePressed(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_tablalistadoMousePressed
        if (evt.getClickCount()==2) {
            ...
            frmreserva.txtidpaciente.setText(cod);
            frmreserva.txtpaciente.setText(valor);
            dispose();
        }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(frmvistapaciente.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new frmvistapaciente().setVisible(true);
            }
        });
    }
