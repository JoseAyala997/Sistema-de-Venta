 ...
 * @author Jose Ayala
 */
public class frmvistanutricionista extends javax.swing.JFrame {

    /**
     * Creates new form frmvistanutricionista
     */
    public frmvistanutricionista() {
        initComponents();
        mostrar("");
    ...
    private void initComponents() {
        ...
        jLabel2.setText("Nutricionistas");
        ...
        lbltotalregistros1.setText("Buscar:");
    ...
    private void tablalistadoMousePressed(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_tablalistadoMousePressed
        if (evt.getClickCount()==2) {
            ...
            frmreserva.txtidprofecional.setText(cod);
            frmreserva.txtprofecional.setText(valor);
            dispose();
        }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(frmvistanutricionista.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new frmvistanutricionista().setVisible(true);
            }
        });
    }
