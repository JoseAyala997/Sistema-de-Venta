 ...
 * @author Jose Ayala
 */
public class frmhistorial_Reservas extends javax.swing.JInternalFrame {

    private Conexion mysql = new Conexion();
    private Connection cn = mysql.conectar();
    public static int comprobar;
    public static String x;
    public frmhistorial_Reservas() {
        initComponents();
         x="x";
    ...
    private void initComponents() {
        ...
        jLabel10.setText("HISTORIAL DE RESERVAS");
    ...
    private void btnnuevoActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnnuevoActionPerformed
        ...
        try {
            report = JasperCompileManager.compileReport(new File("").getAbsolutePath()
                    + "/src/Reportes/Consulta_reservas.jrxml");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(frmhistorial_Reservas.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new frmhistorial_Reservas().setVisible(true);
            }
        });
    }
