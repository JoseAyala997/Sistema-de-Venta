 ...
 * @author Jose Ayala
 */
public class frmhistorial_turnos2 extends javax.swing.JInternalFrame {

    public static String x;

    public frmhistorial_turnos2() {
...
//            JOptionPane.showMessageDialog(rootPane, "La Reserva fue Editada satisfactoriamente");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(frmhistorial_turnos2.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new frmhistorial_turnos2().setVisible(true);
            }
        });
    }
