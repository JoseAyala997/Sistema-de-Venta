 ...
 * @author Jose Ayala
 */
public class frmpaciente_consulta extends javax.swing.JInternalFrame{

    public static String x;
    public frmpaciente_consulta() {
        initComponents();
 ...
 void mostrar(String buscar) {
        try {
            ...
            fpacientes Funcion = new fpacientes();
    ...
    private void initComponents() {
        ...
        jLabel3.setText("Consulta Pacientes");
...
private String accion = "guardar";
    ...
    private void btnguardarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnguardarActionPerformed
          Map p = new HashMap();
            ...
            try {
                ...
                view.setTitle("Consulta Pacientes");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(frmpaciente_consulta.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new frmpaciente_consulta().setVisible(true);
            }
        });
    }
